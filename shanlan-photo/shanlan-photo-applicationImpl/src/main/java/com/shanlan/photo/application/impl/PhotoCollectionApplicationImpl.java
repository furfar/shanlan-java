...
public class PhotoCollectionApplicationImpl implements PhotoCollectionApplication {
    ...
    public void updatePhotoCollection(PhotoCollectionDTO photoCollectionDTO) {
        ...
        photoCollection.setUpdatedAt(DateUtil.getNow(DateUtil.format_yyyyMMdd_HHmmss));
    ...
    public boolean updatePhotoCount(Integer photoCollectionId) {
        Integer photoCount = RePhotoCollectionPhoto.findByPhotoCollectionId(photoCollectionId).size();
