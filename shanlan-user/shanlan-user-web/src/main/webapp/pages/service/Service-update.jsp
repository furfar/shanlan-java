...
<body>
	<form class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-lg-9">
				<input name="serviceName" style="display: inline; width: 94%;"
					class="form-control" type="text" require="false" id="serviceNameID" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-lg-9">
				<input name="serviceId" style="display: inline; width: 94%;"
					class="form-control" type="hidden" id="serviceIdID" />
			</div>
		</div>
		<div class="form-group">
