...
<form class="form-horizontal">
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="serviceId" style="display:inline; width:94%;" class="form-control"  type="text"  id="serviceIdID" />
    </div>
</div>
	           <div class="form-group">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="businessParam" style="display:inline; width:94%;" class="form-control"  type="text"  id="businessParamID" />
    </div>
</div>
	           <div class="form-group">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="errorCode" style="display:inline; width:94%;" class="form-control"  type="text"  id="errorCodeID" />
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-3 control-label">responseSample:</label>
                    <div class="col-lg-9">
                           <input name="responseSample" style="display:inline; width:94%;" class="form-control"  type="text"  id="responseSampleID" />
    </div>
</div>
</form>
