...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input name="url" style="display:inline; width:94%;" class="form-control" type="text"
                   require="false" id="urlID"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <textarea name="businessParam" style="display:inline; width:94%;" class="form-control" type="text"
                   id="businessParamID"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <textarea name="errorCode" style="display:inline; width:94%;" class="form-control" type="text"
                   id="errorCodeID"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <textarea name="responseSample" style="display:inline; width:94%;" class="form-control" type="text"
                   id="responseSampleID"/>
        </div>
    </div>
</form>
