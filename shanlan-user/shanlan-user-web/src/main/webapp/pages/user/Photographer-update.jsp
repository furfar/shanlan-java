...
<form class="form-horizontal">
    ...
    <div class="form-group" style="display: none">
        ...
        <div class="col-lg-9">
            <input name="evaluationRank" style="display:inline; width:94%;" class="form-control" type="text"
                   id="evaluationRankID"/>
        </div>
    </div>
    <div class="form-group" style="display: none">
        ...
        <div class="col-lg-9">
            <input name="evaluationTimes" style="display:inline; width:94%;" class="form-control" type="text"
                   id="evaluationTimesID"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group" style="display: none">
        ...
        <div class="col-lg-9">
            <input name="verifyType" style="display:inline; width:94%;" class="form-control" type="text"
                   id="verifyTypeID"/>
        </div>
    </div>
</form>
