...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="photoIdID"></p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="cityIdID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="birthdayID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="mobileID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="qqID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="webchartID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="alipayID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="tradeTimesID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="activenessID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="photoCountID"></p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="evaluationRankID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="evaluationTimesID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="serviceStatusID"></p>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-3 control-label">other:</label>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="verifyTypeID"></p>
        </div>
    </div>
</form>