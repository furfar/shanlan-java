...
<form class="form-horizontal">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="photographer" style="display:inline; width:94%;" class="form-control"  type="text"  id="photographerID" />
    </div>
</div>
	           <div class="form-group">
	           ...
	           <div class="form-group">
                    ...
                    <div class="col-lg-9">
                           <input name="photoCount" style="display:inline; width:94%;" class="form-control"  type="text"  id="photoCountID" />
    </div>
</div>
	           <div class="form-group">
                    <label class="col-lg-3 control-label">alterCount:</label>
                    <div class="col-lg-9">
                           <input name="alterCount" style="display:inline; width:94%;" class="form-control"  type="text"  id="alterCountID" />
    </div>
</div>
	           <div class="form-group">
