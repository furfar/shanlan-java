...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="priceID"></p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="statusID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="createdAtID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="updatedAtID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="validDateID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="invalidDateID"></p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="photographerID"></p>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <p class="form-control-static" id="daysID"></p>
        </div>
    </div>
    <div class="form-group">
