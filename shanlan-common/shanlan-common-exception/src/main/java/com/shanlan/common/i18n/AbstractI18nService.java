package com.shanlan.common.i18n;
...
import com.shanlan.common.exception.system.NoSuchMessageException;

public abstract class AbstractI18nService extends I18nServiceSupport implements
		HierarchicalI18nService {
	...
	public final String getMessage(String code, Object[] args, Locale locale)
		...
		throw new NoSuchMessageException("No message found under code '" + code
				+ "' for locale '" + locale + "'.");
	}
	...
	protected String getMessageFromParent(String code, Object[] args,
		...
		if (parent != null) {
			if (parent instanceof AbstractI18nService) {
				...
				return ((AbstractI18nService) parent).getMessageInternal(code,
						args, locale);
			} else {
